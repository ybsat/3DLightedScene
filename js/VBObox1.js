function VBObox1() {
  ...
  '  gl_Position = u_MvpMatrix * a_Pos4;\n' +
	...
	'  vec3 diffuse1 = u_LampSet[1].diff * Kd * nDotL1;\n' +
	'  vec3 speculr1;\n' +
	'	 if (lightMode == 1) {\n' +
	...
	'  v_Color = emissive + ambient0 + diffuse0 + speculr0 + ambient1 + diffuse1 + speculr1;\n' +
  ' }\n';
...
VBObox1.prototype.sendLights = function() {
...
VBObox1.prototype.switchMaterial = function(mat) {
...
VBObox1.prototype.sendMatrices = function() {
...
VBObox1.prototype.drawShape0 = function() {
...
VBObox1.prototype.drawShape1 = function() {
...
VBObox1.prototype.drawShape2 = function() {
...
VBObox1.prototype.drawShape3 = function() {
...
VBObox1.prototype.drawCube = function() {
	...
	gl.drawArrays(gl.TRIANGLE_STRIP,
								this.cubeStart/this.floatsPerVertex,
								this.cubeSize / this.floatsPerVertex);
}

VBObox1.prototype.drawTetra = function() {
	this.sendMatrices();
	gl.drawArrays(gl.TRIANGLE_STRIP,
